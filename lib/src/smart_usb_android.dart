...
import 'package:smart_usb/src/smart_usb_platform_interface.dart';

const MethodChannel _channel = MethodChannel('smart_usb');

class SmartUsbAndroid extends SmartUsbPlatform {
  // For example/.dart_tool/flutter_build/generated_main.dart
  static registerWith() {
    SmartUsbPlatform.instance = SmartUsbAndroid();
  }
  ...
  Future<bool> send(List<int> data) async {
    return await _channel.invokeMethod('printBytes', {
      'data': data,
    });
  }
