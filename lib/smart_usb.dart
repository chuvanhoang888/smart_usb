...
import 'src/smart_usb_platform_interface.dart';

export 'src/common.dart';
export 'src/smart_usb_android.dart';
export 'src/smart_usb_desktop.dart';

SmartUsbPlatform get _platform => SmartUsbPlatform.instance;
